...
class HTE_Param_Selector(object):
    ...
    def prompt_generation(self, target_node, global_state):
        ...
        if node_type =='continuous':
            prompt_path = 'causal_inference/hte/context/regressor_select_prompt.txt'
            algo_text_path = 'causal_inference/hte/context/regressor.txt'
        else:
            prompt_path = 'causal_inference/hte/context/classifier_select_prompt.txt'
            algo_text_path = 'causal_inference/hte/context/classifier.txt'
    ...
    def model_suggestion(self, client, prompt):
        response = client.chat_completion(
            prompt=prompt,
            system_prompt="You are a helpful assistant for DML dml_params.",
            json_response=True
        )
        return response
