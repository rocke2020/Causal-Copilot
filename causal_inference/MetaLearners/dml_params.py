...
class HTE_Param_Selector(object):
    ...
    def prompt_generation(self, target_node, global_state):
        ...
        if node_type =='continuous':
            ...
            algo_text_path = 'causal_inference/hte/context/regressor.txt'
        else:
    ...
    def model_suggestion(self, client, prompt):
        response = client.chat_completion(
            prompt=prompt,
            system_prompt="You are a helpful assistant for MetaLearners dml_params.",
            json_response=True
        )
        return response
    ...
    def forward(self, global_state):
        ...
        final_prompt = open('causal_inference/hte/context/final_stage_select_prompt.txt', "r").read()
