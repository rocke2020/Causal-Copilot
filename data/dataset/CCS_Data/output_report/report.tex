...
\begin{minipage}[t]{0.3\linewidth}
    \begin{figure}[H]
        \centering
        \vspace{-0.5cm}
        \resizebox{\linewidth}{!}{\includegraphics[height=0.4\textheight]{data/dataset/CCS_Data/output_graph/potential_relation.pdf}}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{data/dataset/CCS_Data/output_graph/eda_dist.jpg}
