...
\begin{minipage}[t]{0.3\linewidth}
    \begin{figure}[H]
        \centering
        \vspace{-0.5cm}
        \resizebox{\linewidth}{!}{\includegraphics[height=0.4\textheight]{data/dataset/sachs/output_graph/potential_relation.pdf}}
...
\begin{figure}[H]
\centering
\includegraphics[width=\linewidth]{data/dataset/sachs/output_graph/eda_dist.jpg}
...
\begin{minipage}[t]{0.5\linewidth}
    \begin{figure}[H]
        \centering
        \vspace{-1.5cm}
        \includegraphics[width=\linewidth]{data/dataset/sachs/output_graph/eda_corr.jpg}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.3\textwidth}
        \centering
        \vspace{-0.5cm}
        \includegraphics[width=\linewidth]{data/dataset/sachs/output_graph/true_graph.pdf}
        \vfill
        \caption{True Graph}
        \label{fig:sub1}
    \end{subfigure}
    ...
    \begin{subfigure}{0.3\textwidth}
        \centering
        \vspace{-0.5cm}
        \includegraphics[width=\linewidth]{data/dataset/sachs/output_graph/initial_graph.pdf}
        \vfill
    ...
    \begin{subfigure}{0.3\textwidth}
        \centering
        \vspace{-0.5cm}
        \includegraphics[width=\linewidth]{data/dataset/sachs/output_graph/revised_graph.pdf}
        \vfill
...
\begin{figure}[H]
        \centering
        \vspace{-0.5cm}
        \includegraphics[width=0.8\linewidth]{data/dataset/sachs/output_graph/confidence_heatmap.jpg}
