...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\linewidth]{data/dataset/sachs/output_graph/eda_dist.jpg}
...
\begin{figure}[H]
    ...
    \begin{subfigure}{0.4\textwidth}
        \centering
        \includegraphics[width=\linewidth]{data/dataset/sachs/output_graph/Initial_Graph.jpg}
