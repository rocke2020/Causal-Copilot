...
from causal_inference.inference import Analysis
...
DEMO_DATASETS = {
    "Abalone": {
        ...
        "path": "data/dataset/Abalone/Abalone.csv",
    ...
    "Sachs": {
        ...
        "path": "data/dataset/sachs/sachs.csv", 
    ...
    "CCS Data": {
        ...
        "path": "data/dataset/CCS_Data/CCS_Data.csv",
    ...
    "Earth Quakes": {
        ...
        "path": "data/dataset/earthquakes/earthquakes.csv",
    ...
    "Online Shop": {
        ...
        "path": "data/dataset/onlineshop/2021online_shop.csv",
    ...
    "Linear_Gaussian": {
        ...
        "path": "data/dataset/Linear_Gaussian/Linear_Gaussian_data.csv",
    ...
    "Linear_Nongaussian": {
        ...
        "path": "data/dataset/Linear_Nongaussian/Linear_Nongaussian_data.csv", 
    ...
    time_lag: [an integer] / default / None
        ...
        # Algorithm Selection
            if global_state.algorithm.selected_algorithm is None:
                ...
                if REQUIRED_INFO["interactive_mode"]:
                    ...
                    from web_demo.algo_context import TABULAR_CUDA, TABULAR_CPU, TS
                    if global_state.statistics.time_series: 
        ...
        if CURRENT_STAGE == 'report_generation':    
            ...
            with open(f'{global_state.user_data.output_graph_dir}/inference_information.json', 'w') as f:
                json.dump(extracted_data_inf, f, indent=4, default=str)
